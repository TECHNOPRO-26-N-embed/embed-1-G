...
ジョイスティックでサーボモーターを動かし、サーボに付けた超音波センサーで周りを調べます。
物を見つけたときは、LEDの光とブザーの音で知らせるようにしました。
...
**動いたもの：**
- ジョイスティックと使ってサーボモーターを動かす
- HC‑SR04超音波センサーで周りを調べる
- LEDやアクティブブザーで警報する
...
- バッテリーと左右の車輪用モーター、無線操作機能を追加すれば、移動しながら周囲をスキャンできる小型ロボットに発展させられると考えています。
